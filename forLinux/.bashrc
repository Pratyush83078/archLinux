...
#CUSTOM-SCRIPT
alias bak-forArch='cp ~/.bashrc ~/.bash_history ~/.config/sway/config ~/.config/gtk-3.0/gtk.css ~/Documents/forLinux/ && git add ~/Documents/forLinux && git commit -m "automated: bashrc,bash_hist,sway_config,gtk.css" && git push origin main'
